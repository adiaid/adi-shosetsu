-- {"id":444444444,"ver":"1.0.1","libVer":"1.0.0","author":"MechTechnology"}

local baseURL = "https://citrusaurora.com"
...
local function shrinkURL(url)
	return url:gsub("^.-citrusaurora%.com", "")
end
...
return {
	...
	name = "Citrus Aurora",
	baseURL = baseURL,
	imageURL = "https://github.com/adiaid/adi-shosetsu/blob/master/icons/CitrusAurora.png",
