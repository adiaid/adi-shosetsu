-- {"id":103333333,"ver":"1.0.1","libVer":"1.0.0","author":"MechTechnology","dep":["Madara>=2.3.0"]}

return Require("Madara")("https://salmonlatte.com", {
	id = 103333333,
	name = "Salmon Latte",
	imageURL = "https://github.com/adiaid/adi-shosetsu/blob/master/icons/SalmonLatte.png",
