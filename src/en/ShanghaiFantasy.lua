-- {"id":105555555,"ver":"1.0.1","libVer":"1.0.0","author":"MechTechnology","dep":["Madara>=2.3.0"]}

return Require("Madara")("https://shanghaifantasy.com", {
	id = 105555555,
	name = "Shanghai Fantasy",
	imageURL = "https://github.com/adiaid/adi-shosetsu/blob/master/icons/ShanghaiFantasy.png",
