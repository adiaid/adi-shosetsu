-- {"id":107777777,"ver":"1.0.1","libVer":"1.0.0","author":"MechTechnology","dep":["Madara>=2.3.0"]}

return Require("Madara")("https://sleepytranslations.com", {
	id = 107777777,
	name = "Sleepy Translations",
	imageURL = "https://github.com/adiaid/adi-shosetsu/blob/master/icons/SleepyTranslations.png",
