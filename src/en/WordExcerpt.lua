-- {"id":202222222,"ver":"1.0.1","libVer":"1.0.0","author":"MechTechnology"}

local baseURL = "https://wordexcerpt.com"
...
local function shrinkURL(url)
	return url:gsub("^.-wordexcerpt%.com", "")
end
...
return {
	...
	name = "WordExcerpt",
	baseURL = baseURL,
	imageURL = "https://github.com/adiaid/adi-shosetsu/blob/master/icons/WordExcerpt.png",
